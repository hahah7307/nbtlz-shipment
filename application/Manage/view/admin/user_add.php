    ...
    <div class="right">
		...
		<div class="layui-form">
			...
			<div class="layui-form-item">
				...
				<div class="layui-input-inline w300">
					<input type="text" class="layui-input" name="nickname" placeholder="请填写用户昵称">
				</div>
			</div>
			<div class="layui-form-item">
			...
			<div class="layui-form-item">
				...
				<div class="layui-input-inline w300">
					<input type="text" class="layui-input" name="email" placeholder="请填写邮箱">
				</div>
			</div>
			<div class="layui-form-item">
...
layui.use(['form', 'jquery'], function(){
	...
	form.on('submit(formCoding)', function(data){
		...
		button.text('请稍候...');
		$.ajax({
			type:'POST',url:"{:url('user_add')}",data:data.field,dataType:'json',
