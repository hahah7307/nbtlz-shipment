        ...
        <div class="layui-form">
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline w300">
                    <input type="text" class="layui-input" name="contract_no" value="{$info.contract_no}" disabled placeholder="请填写产品名称">
                </div>
            </div>
            <div class="layui-form-item">
                ...
                <div class="layui-input-block w300">
                    <select name="sku_id" lay-verify="required">
                        ...
                        <option value="{$v.id}" {if condition="$info.sku_id eq $v.id"}selected{/if}>{$v.sku}({$v.name})</option>
                        {/foreach}
                    </select>
                </div>
            </div>
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline w300">
                    <input type="text" class="layui-input" name="product_quantity" value="{$info.product_quantity}" placeholder="请填写产品数量">
                </div>
            </div>
            <div class="layui-form-item">
